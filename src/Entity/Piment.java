...
public class Piment extends Ennemi {
	
	public Piment(Map map, Fenetre fen, int x, int y) {
		super(map, fen);
		...
		sprite = new JLabel(new ImageIcon(getClass().getResource("/images/personnages/piment_gauche.png"))); //Ajout de l'image du cuisinier au label
		spriteDroitName = "/images/personnages/piment_droit.png";
		spriteGaucheName = "/images/personnages/piment_gauche.png";
